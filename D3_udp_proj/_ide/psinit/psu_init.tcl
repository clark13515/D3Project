...
set psu_pll_init_data {
    ...
    mask_write 0XFF5E0044 0x00003F00 0x00000600
		# : IOPLL FRAC CFG
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180028 0x000000FE 0x00000020
    ...
    mask_write 0XFF18002C 0x000000FE 0x00000020
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0xD5000600
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x03BFF69E
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x02FFF9FF
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01FFF5B5
    ...
    mask_write 0XFF180168 0x03FFFFFF 0x03FFFE6A
    ...
    mask_write 0XFF180178 0x03FFFFFF 0x02F80F80
    ...
    mask_write 0XFF180184 0x03FFFFFF 0x03034034
		# : LOOPBACK
