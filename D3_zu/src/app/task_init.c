...
static uint8_t            g_task_init_eth_ip[4]            = {192,168,0,5};
static uint8_t            g_task_init_eth_netmask[4]       = {255,255,255,0};
static uint8_t            g_task_init_eth_gateway[4]       = {192,168,0,1};
...
static void xemacpsif_mac_LLDP_hash_update (struct netif *netif)
{
	...
	multicast_mac_addr[1] = 0x80;
	multicast_mac_addr[2] = 0xc2;
	multicast_mac_addr[3] = 00;
	multicast_mac_addr[4] = 00;
	multicast_mac_addr[5] = 0x0e;
    ...
    multicast_mac_addr[0] = 0x01;
	multicast_mac_addr[1] = 0x1B;
	multicast_mac_addr[2] = 0x19;
	multicast_mac_addr[3] = 00;
	multicast_mac_addr[4] = 00;
	multicast_mac_addr[5] = 0x00;
...
static int task_init_eth_lwip_stack_init(void)
{
    ...
    xemacpsif_mac_LLDP_hash_update(g_task_init_eth_netif_info.netif_handle);
